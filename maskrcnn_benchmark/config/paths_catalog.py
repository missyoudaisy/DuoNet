...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "openimage_v4": {
            "img_dir": "open_image_v4/images",
            "ann_file": "open_image_v4/annotations/vrd-%s-anno.json",
            "cate_info_file": "open_image_v4/annotations/categories_dict.json",
        },
