...
_C.MODEL.PRETRAINED_DETECTOR_CKPT_OIV6 = ""
...
_C.MODEL.ROI_BOX_HEAD.VG_NUM_CLASSES = 81
...
_C.MODEL.ROI_RELATION_HEAD.FEATURE_EXTRACTOR_MINI = "FPNOnlyFeatureExtractor"
...
_C.MODEL.ROI_RELATION_HEAD.MOMENTUM = 0.999
...
# for 2D feature
_C.MODEL.ROI_RELATION_HEAD.POOLER_RESOLUTION = 8
...
_C.SECOND_STAGE_START_ITER = 60001

_C.GLOBAL_SETTING = CN()
_C.GLOBAL_SETTING.DATASET_CHOICE = ""
_C.GLOBAL_SETTING.CHOOSE_BEST_MODEL_BY_METRIC = ""